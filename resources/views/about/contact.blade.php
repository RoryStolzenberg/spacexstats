...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <main>
            ...
            <p>For issues relating to your account including billing, general feedback, and enquiries:<br/>
            <a href="mailto:contact@spacexstats.com">contact@spacexstats.com</a></p>

            <h3>Tips & Information</h3>
            <p>If you have a tipoff or want to provide information, contact us here. All tips & sources are treated securely.<br/>
            ...
            <a href="mailto:webmaster@spacexstats.com">webmaster@spacexstats.com</a></p>
