...
class Checker {
    ...
    private function resolve() {
        foreach ($this->filetypes as $mediaType => $arrayOfFileTypes) {
            if (in_array(strtolower($this->file->getClientOriginalExtension()), $arrayOfFileTypes) && in_array($this->file->getMimeType(), $arrayOfFileTypes)) {
                return MissionControlType::$mediaType;
            }
        }
        return false;
    }
