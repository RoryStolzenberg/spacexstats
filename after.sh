...
echo command=php /home/vagrant/spacexstats/artisan queue:work redis --queue=default,live,email,uploads --sleep=0 --tries=3 --daemon >> /etc/supervisor/conf.d/laravel-worker.conf
